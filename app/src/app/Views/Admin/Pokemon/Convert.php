...
<div class="bg-white p-8 border border-gray-300 rounded shadow-md">
    ...
    <div id="errorMessages" class="hidden col-span-1 md:col-span-2 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative">
    </div>
    ...
    <form action="/admin/pokemon/intercanvis" method="post">
        <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mb-4">
            ...
            <div class="w-full md:w-1/3">
                <label for="points" class="block text-sm font-medium text-gray-700 mb-1">Punts</label>
