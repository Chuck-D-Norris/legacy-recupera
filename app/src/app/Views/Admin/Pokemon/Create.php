...
<div class="bg-white p-8 border border-gray-300 rounded shadow-md">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Creando nuevo Pokémon</h2>

    <form id="pokemonForm" action="/admin/pokemon/store" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
